package com.vinsguru.cloudstreamkafkaplayground.sec09;
...
public class FanOutWithTuplesTest extends AbstractIntegrationTest {

    private static final Logger log = LoggerFactory.getLogger(FanOutWithTuplesTest.class);
    ...
    @Test
    public void fanOutWithTuplesTest(){
